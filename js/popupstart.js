function FirstApplication(){
	...
	appendsOptionsToId('fav1', createOptionsChamps("Default", currRole));
    appendsOptionsToId('fav2', createOptionsChamps("Default", currRole));
    appendsOptionsToId('fav3', createOptionsChamps("Default", currRole));
